      ...
      <div className="">
        {isLoading ? (
          ...
          <div className="flex flex-col gap-2 pr-4">
            ...
            <ScrollArea className="h-[calc(100vh-24rem)] overflow-y-auto">
              {goals
                ...
                .map((goal) => {
                  return (
                    <div key={goal.id} className="">
                      {editGoalId === goal.id ? (
                        <EditGoal key={goal.id} goal={goal} onSave={onSaveEditGoal} onCancel={onCancelEditGoal} />
                      ) : (
                        <div className="group flex justify-between gap-0 py-3">
                          <div className="flex items-start gap-3">
                            {isUpdatingGoal && goal.id === updateGoalVariables?.id ? (
                              ...
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => toggleGoalStatus(goal.id, checked)}
                              />
                            )}
                          ...
                          <div className=" flex z-10 -translate-y-6 gap-0 opacity-0 transition-all group-hover:-translate-y-1 group-hover:opacity-100">
                            <Button
                              size="sm"
                              variant="ghost"
